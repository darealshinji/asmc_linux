...
$_048:	cmp	dword ptr [rbp-0xC], ecx
	...
	mov	ecx, 643
	mov	edx, 1030
$_049:	cmp	dword ptr [rbp-0x4], 619
	jnz	$_050
...
$_052:	cmp	dword ptr [rbp-0x4], 713
	jnz	$_058
...
$_063:	cmp	dword ptr [rbp-0x4], 619
	je	$_059
	cmp	dword ptr [rbp-0x4], 612
	jz	$_060
	cmp	dword ptr [rbp-0x4], 617
	jz	$_061
	jmp	$_062
...
ofss:
	.byte  0x0F, 0x10, 0x0A, 0x0A  /* T_SI,    T_DI,    T_CX,    T_CX  */
	.byte  0x17, 0x18, 0x12, 0x12  /* T_ESI,   T_EDI,   T_ECX,   T_ECX */
	.byte  0x79, 0x7A, 0x74, 0x12  /* T_RSI,   T_RDI,   T_RCX,   T_ECX */
	.byte  0x09, 0x11, 0x73, 0x00  /* T_AX,    T_EAX,   T_RAX,   0     */
	.byte  0xCF, 0xD2, 0xD6, 0x00  /* T_WORD,  T_DWORD, T_QWORD, 0     */
...
DS0001:
	.ascii " mov %r, %r ptr %s[%d]\n"
	.asciz " mov %r ptr %s[%d], %r"

DS0002:
	.ascii " mov eax, dword ptr %s[%d]\n"
	.asciz " mov dword ptr %s[%d], eax"

DS0003:
	.ascii " mov al, byte ptr %s[%d]\n"
	.asciz " mov byte ptr %s[%d], al"
...
DS0007:
	.ascii " mov eax, dword ptr %s[4]\n"
	.ascii " cmp dword ptr %s[4], eax\n"
	.ascii " jne %s\n"
	.ascii " mov eax, dword ptr %s\n"
	.ascii " cmp dword ptr %s, eax\n"
	.asciz "%s:"

DS0008:
	.ascii " add dword ptr %s, dword ptr %s\n"
	.asciz " adc dword ptr %s[4], dword ptr %s[4]"

DS0009:
	.ascii " sub dword ptr %s, dword ptr %s\n"
	.asciz " sbb dword ptr %s[4], dword ptr %s[4]"

DS000A:
	.ascii " %r dword ptr %s, dword ptr %s\n"
	.asciz " %r dword ptr %s[4], dword ptr %s[4]"
