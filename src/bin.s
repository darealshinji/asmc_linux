...
pe32def:
	.byte   'P',  'E', 0x00, 0x00
	/* file header */
	.byte  0x4C, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte  0xE0, 0x00, 0x0F, 0x01
	/* Optional Header */
...
pe64def:
	.byte   'P',  'E', 0x00, 0x00
	/* file header */
	.byte  0x64, 0x86, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte  0xF0, 0x00, 0x2F, 0x01
	/* Optional Header */
...
DS0001:
	.ascii "option dotname\n"
	.ascii "IMAGE_DOS_HEADER STRUC\n"
	.ascii "e_magic         dw ?\n"
	.ascii "e_cblp          dw ?\n"
	.ascii "e_cp            dw ?\n"
	.ascii "e_crlc          dw ?\n"
	...
	.ascii "e_lfarlc        dw ?\n"
	.ascii "e_ovno          dw ?\n"
	.ascii "e_res           dw 4 dup(?)\n"
	.ascii "e_oemid         dw ?\n"
	.ascii "e_oeminfo       dw ?\n"
	.ascii "e_res2          dw 10 dup(?)\n"
	.ascii "e_lfanew        dd ?\n"
	.ascii "IMAGE_DOS_HEADER ENDS\n"
	.ascii "%s1 segment USE16 word %s\n"
	.ascii "IMAGE_DOS_HEADER { 0x5A4D, 0x68, 1, 0, 4, 0, -1, 0, 0xB8, 0, 0, 0, 0x40 }\n"
	.ascii "push cs\n"
	.ascii "pop ds\n"
	.ascii "mov dx,@F-40h\n"
	.ascii "mov ah,9\n"
	...
	.ascii "int 21h\n"
	.ascii "@@:\n"
	.ascii "db 'This is a PE executable',0Dh,0Ah,'$'\n"
	.asciz "%s1 ends"
...
DS000B:
	.ascii "option dotname\n"
	.ascii "%s segment dword %s\n"
	.asciz "DD 0, 0%xh, 0, imagerel @%s_name, %u, %u, %u, imagerel @%s_func, imagerel @%s_names, imagerel @%s_nameord"

DS000C:
	.asciz ".edata"

DS000D:
	.asciz "FLAT read public alias('.rdata') 'DATA'"

DS000E:
	.asciz "@%s_func label dword"

DS000F:
	.asciz "dd imagerel %s"

DS0010:
	.asciz "@%s_names label dword"

DS0011:
	.asciz "dd imagerel @%s"

DS0012:
	.asciz "@%s_nameord label word"
...
DS0019:
	.ascii "@LPPROC typedef ptr proc\n"
	.asciz "option dotname"

DS001A:
	.asciz ".idata$"

DS001B:
	.ascii "%s2 segment dword %s\n"
	.ascii "dd imagerel @%s_ilt, 0, 0, imagerel @%s_name, imagerel @%s_iat\n"
	.ascii "%s2 ends\n"
	.ascii "%s4 segment %s %s\n"
	.asciz "@%s_ilt label %r"

DS001C:
	.asciz "@LPPROC imagerel @%s_name"

DS001D:
	.ascii "@LPPROC 0\n"
	.ascii "%s4 ends\n"
	.ascii "%s5 segment %s %s\n"
	.asciz "@%s_iat label %r"

DS001E:
	.asciz "%s%s @LPPROC imagerel @%s_name"

DS001F:
	.ascii "@LPPROC 0\n"
	.ascii "%s5 ends\n"
	.asciz "%s6 segment word %s"
...
DS0031:
	.asciz "Segment                  Pos(file)     RVA  Size(fil) Size(mem)"

DS0032:
	.asciz "---------------------------------------------------------------"

DS0033:
	.asciz "%-24s %8X %8X %9X %9X"
