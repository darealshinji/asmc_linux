...
$_005:	cmp	dword ptr [rbx+0x4], 709
	jnz	$_009
	add	rbx, 24
	cmp	byte ptr [rbx], 41
	jnz	$_006
...
$_009:	cmp	dword ptr [rbx+0x4], 708
	jne	$_016
	inc	dword ptr [rbp+0x28]
...
$_024:	cmp	dword ptr [rbx+0x4], 709
	jnz	$_028
	add	rbx, 24
	cmp	byte ptr [rbx], 41
	jnz	$_025
...
$_028:	cmp	dword ptr [rbx+0x4], 708
	jnz	$_032
	add	rbx, 24
	cmp	byte ptr [rbx], 41
	jnz	$_029
...
$_081:	cmp	dword ptr [rbx+0x4], 709
	jnz	$_083
	add	rbx, 24
	cmp	byte ptr [rbx], 41
	jnz	$_082
...
$_083:	cmp	dword ptr [rbx+0x4], 708
	jne	$_100
...
$_090:	cmp	dword ptr [rbx+0x4], 708
	jne	$_100
...
DS0000:
	.asciz " option dllimport:<%s>"

DS0001:
	.asciz "includelib \"%s.lib\""
...
DS0010:
	.asciz "OPTION FIELDALIGN: %s"

DS0011:
	.asciz ".pragma-push-pop"
