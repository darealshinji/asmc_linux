...
$_033:	cmp	dword ptr [rcx+0x4], 545
	je	$_022
	cmp	dword ptr [rcx+0x4], 546
	jz	$_032
...
NopList16:
    .byte  3                  /* objlen of first NOP pattern */
    .byte  0x2E, 0x8b, 0xc0   /* MOV AX,AX */
    /* v2.11: Masm v6+ uses 8B CO; Masm v5 uses 87 DB (xchg bx, bx) */
    .byte  0x8b, 0xc0         /* MOV AX,AX */
    .byte  0x90               /* NOP */

NopList32:
    .byte  7
    .byte  0x8d,0xa4,0x24,0,0,0,0         /* lea     esp,[esp+00000000] */
    .byte  0x8d,0x80,0,0,0,0              /* lea     eax,[eax+00000000] */
    .byte  0x2e,0x8d,0x44,0x20,0x00       /* lea     eax,cs:[eax+no_index_reg+00H] */
    .byte  0x8d,0x44,0x20,0x00            /* lea     eax,[eax+no_index_reg+00H] */
    .byte  0x8d,0x40,0x00                 /* lea     eax,[eax+00H] */
    .byte  0x8b,0xff                      /* mov     edi,edi */
    .byte  0x90                           /* nop */

NopList64:
    .byte  7
    .byte  0x0f,0x1f,0x80,0,0,0,0         /* nop dword ptr [rax+0] */
    .byte  0x66,0x0f,0x1f,0x44,0,0        /* nop word ptr [rax+rax] */
    .byte  0x0f,0x1f,0x44,0,0             /* nop dword ptr [rax+rax] */
    .byte  0x0f,0x1f,0x40,0               /* nop dword ptr [rax] */
    .byte  0x0f,0x1f,0                    /* nop dword ptr [rax] */
    .byte  0x66,0x90                      /* xchg ax,ax */
    .byte  0x90                           /* nop */
