...
$C0028: cmp	dword ptr [rdi+0x3C], 3
	jnz	$_031
	mov	r8d, 8
	mov	rdx, rdi
	mov	rcx, rsi
...
$C002C: cmp	dword ptr [rdi+0x3C], 3
	jnz	$_033
	mov	r8d, 8
	mov	rdx, rdi
	mov	rcx, rsi
...
$C0031:
$C0032:
$C0033: cmp	dword ptr [rbp+0x48], 249
	jnz	$_035
...
$C003B: mov	rbx, qword ptr [rdi+0x50]
	test	rbx, rbx
	jz	$_041
...
$C006F:
$C0070:
$C0071: mov	eax, dword ptr [rbp+0x48]
...
$C009B: cmp	dword ptr [rdi+0x3C], 1
	jnz	$_109
	cmp	byte ptr [rdi+0x40], -64
	jz	$_110
...
$C009F: test	byte ptr [rdi+0x43], 0x08
	jnz	$_111
	mov	ecx, 2010
	call	qword ptr [fnasmerr+rip]
	jmp	$_180
...
$C00A6:
$C00A7: mov	rbx, qword ptr [rbp+0x40]
	mov	dword ptr [rsi+0x3C], 0
	cmp	dword ptr [rdi+0x38], -2
	jz	$_117
	cmp	byte ptr [rdi+0x40], -64
...
$C00FC: cmp	dword ptr [rdi+0x3C], 3
	jnz	$_172
	mov	r8d, 16
	mov	rdx, rdi
	mov	rcx, rsi
...
$C0106: cmp	dword ptr [rdi+0x3C], 3
	jz	$_178
	mov	ecx, 2176
	call	qword ptr [fnasmerr+rip]
	jmp	$_180
...
$_202:
	...
	test	eax, 0x10
	jz	$_203
	cmp	dword ptr [rcx-0x44], 1332
	jnc	$_203
	cmp	dword ptr [rcx-0x44], 961
	jc	$_203
	xor	eax, eax
	jmp	$_204
...
$_236:	cmp	byte ptr [rbx+0x30], 0
	je	$_320
	cmp	dword ptr [rbx+0x34], 616
	jne	$_320
	cmp	dword ptr [rbx-0x44], 688
	je	$_320
	add	rbx, 72
...
$C02FA: test	byte ptr [rsi+0x43], 0x08
	jz	$_592
	test	byte ptr [rdi+0x43], 0x08
	jz	$_592
	mov	r8d, 4294967295
...
$C0300: test	byte ptr [rsi+0x43], 0x08
	jz	$_596
	test	byte ptr [rdi+0x43], 0x08
	jz	$_596
	xor	r8d, r8d
...
$C0305: cmp	dword ptr [rsi+0x3C], 3
	jnz	$_601
	mov	rdx, rdi
	mov	rcx, rsi
	call	__cmpq@PLT
...
$C030A: cmp	dword ptr [rsi+0x3C], 3
	jnz	$_604
	mov	rdx, rdi
	mov	rcx, rsi
	call	__cmpq@PLT
...
$C030F: cmp	dword ptr [rsi+0x3C], 3
	jnz	$_607
	mov	rdx, rdi
	mov	rcx, rsi
	call	__cmpq@PLT
...
$C0314: cmp	dword ptr [rsi+0x3C], 3
	jnz	$_610
	mov	rdx, rdi
	mov	rcx, rsi
	call	__cmpq@PLT
...
$C032D: cmp	dword ptr [rsi+0x3C], 3
	jz	$_624
	mov	ecx, 2187
	call	qword ptr [fnasmerr+rip]
...
$C032F: cmp	dword ptr [rsi+0x3C], 3
	jz	$_625
	mov	ecx, 2187
	call	qword ptr [fnasmerr+rip]
...
$C0331: cmp	dword ptr [rsi+0x3C], 3
	jz	$_626
	mov	ecx, 2187
	call	qword ptr [fnasmerr+rip]
$_626:	xor	r8d, r8d
...
$C0333: cmp	dword ptr [rsi+0x3C], 3
	jz	$_627
	mov	ecx, 2187
	call	qword ptr [fnasmerr+rip]
...
$C0335: cmp	dword ptr [rsi+0x3C], 3
	jnz	$_628
	mov	rax, qword ptr [rdi+0x8]
...
$C0337: cmp	dword ptr [rsi+0x3C], 3
	jnz	$_629
	mov	rax, qword ptr [rdi+0x8]
...
$C0339: cmp	dword ptr [rsi+0x3C], 3
	jnz	$_630
	mov	rax, qword ptr [rdi+0x8]
...
$_631:	cmp	rax, 612
	...
	push	rax
	lea	r11, [$C02FF+rip]
	movzx	eax, byte ptr [r11+rax-(612)+(IT$C033B-$C02FF)]
...
$_633:	cmp	dword ptr [rbx+0x4], 688
	jnz	$_636
	mov	rcx, rdi
	call	$_343
	cmp	dword ptr [rdi+0x3C], 0
...
$_746:	lea	rax, [asmerr@PLT+rip]
	test	byte ptr [rbp+0x40], 0x01
	jz	$_747
	lea	rax, [noasmerr+rip]
$_747:	mov	qword ptr [fnasmerr+rip], rax
...
ExprEvalInit:
	sub	rsp, 8
	lea	rax, [asmerr@PLT+rip]
	mov	qword ptr [fnasmerr+rip], rax
	xor	eax, eax
	mov	qword ptr [thissym+rip], rax
	mov	qword ptr [nullstruct+rip], rax
	mov	qword ptr [nullmbr+rip], rax
