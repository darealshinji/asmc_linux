...
$C0146: cmp	qword ptr [ModuleInfo+0x80+rip], 0
	jz	$_271
	mov	byte ptr [ModuleInfo+0x1DB+rip], 1
$_271:	jmp	$C0148

$C0149: mov	byte ptr [ModuleInfo+0x1DC+rip], 1
	jmp	$C0148
$C014A:
$C014B: mov	byte ptr [ModuleInfo+0x1DB+rip], 0
	jmp	$C0148
$C014C:
$C014D: cmp	esi, dword ptr [ModuleInfo+0x220+rip]
	jnz	$_272
...
$C0155: cmp	qword ptr [ModuleInfo+0x80+rip], 0
	jz	$_276
	mov	byte ptr [ModuleInfo+0x1DB+rip], 1
$C0156:
$_276:	mov	byte ptr [ModuleInfo+0x1DE+rip], 1
$C0157:
$C0158: mov	byte ptr [ModuleInfo+0x1DD+rip], 1
	jmp	$C0148
$C0159:
$C015A: mov	byte ptr [ModuleInfo+0x1DD+rip], 0
	jmp	$C0148

$C015B: xor	byte ptr [ModuleInfo+0x1DD+rip], 0x01
	jmp	$C0148
$C015C:
...
$_281:	cmp	eax, 310
	...
	push	rax
	lea	r11, [$C015D+rip]
	movzx	eax, byte ptr [r11+rax-(310)+($C0162-$C015D)]
	sub	r11, rax
	pop	rax
	jmp	r11
$C0162:
...
DS0052:
	.asciz "  %s %s      %6X  %7X  %016lX %s"

DS0053:
	.asciz "  %s %s      %6X  %7X  %08X %s"
...
DS005B:
	.asciz "%s %s        P %-6s %04X     %-8s "

DS005C:
	.asciz "%s %s        P %-6s %08X %-8s "
...
DS0063:
	.asciz "  %s %s        %-17s %s %c %04X"

DS0064:
	.asciz "%s[%u]"

DS0065:
	.asciz "  %s %s        L %-6s %08X %s"

DS0066:
	.asciz "  %s %s        L %-6s %04X     %s"
...
DS0038:
	.asciz "Structures and Unions:"

DS0039:
	.asciz "                N a m e                 Size/Ofs   Type"

DS003A:
	.asciz "Records:"

DS003B:
	.ascii "                N a m e                 Width   # fields\n"
	.asciz "                                        Shift   Width    Mask   Initial"

DS003C:
	.asciz "Types:"

DS003D:
	.asciz "                N a m e                 Size    Attr"

DS003E:
	.asciz "Segments and Groups:"

DS003F:
	.asciz "                N a m e                 Size     Length   Align   Combine Class"

DS0040:
	.asciz "Procedures, parameters and locals:"

DS0041:
	.asciz "                N a m e                 Type     Value    Segment  Length"

DS0042:
	.asciz "Symbols:"

DS0043:
	.asciz "                N a m e                 Type       Value     Attr"
