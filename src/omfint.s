...
$C0007: mov	al, byte ptr [rsi+0x10]
	or	al, byte ptr [rsi+0x11]
	mov	byte ptr [rbp-0xFF4], al
	jmp	$C0006

$C0008: mov	al, byte ptr [rsi+0x11]
...
$C000D: mov	al, byte ptr [rsi+0x10]
...
$C0010: mov	byte ptr [rbp-0xFF4], -120
...
$C0016: mov	al, byte ptr [rsi+0x10]
	add	al, byte ptr [rsi+0x11]
	mov	byte ptr [rbp-0xFF4], al
	lea	rax, [rsi+0x14]
	call	$_003
...
$C0018: mov	al, byte ptr [rsi+0x10]
	add	al, byte ptr [rsi+0x11]
	mov	byte ptr [rbp-0xFF4], al
	movzx	eax, byte ptr [rsi+0x14]
	mov	ecx, dword ptr [rbx]
...
func_index:
	.byte  0x06, 0x00, 0x00, 0x00  /* 80 THEADR, LHEADR, PEDATA, PIDATA  */
	.byte  0x05, 0x07, 0x01, 0x00  /* 88 COMENT, MODEND, EXTDEF, TYPDEF  */
	.byte  0x08, 0x00, 0x09, 0x01  /* 90 PUBDEF, LOCSYM, LINNUM, LNAMES  */
	.byte  0x03, 0x01, 0x02, 0x00  /* 98 SEGDEF, GRPDEF, FIXUP,  ???     */
	.byte  0x04, 0x04, 0x00, 0x00  /* A0 LEDATA, LIDATA, LIBHED, LIBNAM  */
	.byte  0x00, 0x00, 0x00, 0x00  /* A8 LIBLOC, LIBDIC, ???,    ???     */
	.byte  0x01, 0x02, 0x01, 0x08  /* B0 COMDEF, BAKPAT, LEXTDEF,LPUBDEF */
	.byte  0x01, 0x00, 0x01, 0x00  /* B8 LCOMDEF,???,    CEXTDEF,???     */
	.byte  0x00, 0x0A, 0x0B, 0x01  /* C0 ???,    COMDAT, LINSYM, ALIAS   */
	.byte  0x02, 0x01              /* C8 NBKPAT, LLNAMES                 */
