...
$_358:	cmp	dword ptr [rbp-0x6C], 526
	jnz	$_360
	lea	r11, [SpecialTable+rip]
	imul	eax, dword ptr [rbx+0x4], 12
...
$_376:	cmp	dword ptr [rbp-0x6C], 525
	je	$_368
	cmp	dword ptr [rbp-0x6C], 526
	je	$_371
	cmp	dword ptr [rbp-0x6C], 527
	je	$_374
$_377:	jmp	$_379

$_378:	cmp	dword ptr [rbp-0x6C], 521
	je	$_340
	cmp	dword ptr [rbp-0x6C], 522
	je	$_350
	cmp	dword ptr [rbp-0x6C], 523
	je	$_352
	cmp	dword ptr [rbp-0x6C], 524
	je	$_354
	cmp	dword ptr [rbp-0x6C], 525
	je	$_357
	cmp	dword ptr [rbp-0x6C], 526
...
DS000A:
	.ascii "%s %r align(%u) flat read 'DATA'\n"
	.asciz "$xdatasym label near"

DS000B:
	.asciz "db %ut + (0%xh shl 3), %ut, %ut, 0%xh + (0%xh shl 4)"
...
DS0014:
	.asciz "%s SEGMENT ALIGN(4) flat read 'DATA'"

DS0015:
	.ascii "dd IMAGEREL %s, IMAGEREL %s+0%xh, IMAGEREL $xdatasym+0%xh\n"
	.asciz "%s ENDS"
...
DS0018:
	.asciz "option prologue:none\n"

DS0019:
	.asciz " (%s, 0%XH, 0%XH, 0%XH, <<%s>>, <%s>)"
...
DS002C:
	.asciz "User registers inside frame: use -Cs or OPTION CSTACK:ON"

DS002D:
	.asciz "%r [%r][%d],%r"

DS002E:
	.ascii "mov DWORD PTR [%r][%d],%d\n"
	.asciz "mov DWORD PTR [%r+4][%d],48+%d"

DS002F:
	.asciz "mov [%r+0x%X][%d],%r"

DS0030:
	.asciz ".if al"

DS0031:
	.asciz "movaps [%r+0x%X][%d],%r"

DS0032:
	.asciz ".endif"

DS0033:
	.ascii "assume fs:nothing\n"
	.ascii "mov rax,fs:[0x28]\n"
	.ascii "assume fs:error\n"
	.asciz "mov [%r+0x18][%d],rax"

DS0034:
	.ascii "lea rax,[%r+0x10][%d]\n"
	.ascii "mov [%r+0x08][%d],rax\n"
	.ascii "lea rax,[%r+0x20][%d]\n"
	.ascii "mov [%r+0x10][%d],rax\n"
	.asciz "lea rax,[%r][%d]"
